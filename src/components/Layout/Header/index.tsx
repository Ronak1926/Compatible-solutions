...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full dark:bg-transparent transition-all flex flex-col ${sticky
        ? 'shadow-lg bg-white dark:shadow-dark-md dark:bg-darklight!'
        : 'shadow-none'
        }`}>
      <TopBar />
      <div className='container mx-auto max-w-6xl flex items-center justify-between p-4 lg:p-6'>
        <Logo />
